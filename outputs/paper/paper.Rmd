...
```{r at1, echo=FALSE, fig.width=10, fig.height=3}
#video vs control
...
### T test2
```{r at2, echo=FALSE, fig.width=10, fig.height=3}
#video vs text
...
```
### T test3
```{r at3, echo=FALSE, fig.width=10, fig.height=3}
#video vs audio
...
```
### T test 4
```{r at4, echo=FALSE, fig.width=10, fig.height=3}
#video vs skit
...
```{r regression, echo=FALSE, warning=FALSE, fig.width=8, fig.height=8}
