...
We replicate this paper using R statistical programming language [@citeR]. In particular, we use packages `tidyverse` [@citetidyverse],  `here` [@citehere], `ggpubr` [@citeggpubr] to manipulate data and packages, `kableExtra` [@citekableExtra] to generate tables, and `ggplot2` [@citeggplot], `ggthemes` [@citeggthemes] to adjust diagrams themes. 
...
```{r education, fig.cap = "Educational level by PID",echo=FALSE, warning=FALSE,fig.width=10, fig.height=7}
edu <- 
  EDA%>%
...
```{r missing, fig.cap="Missing value Visualization ", echo=FALSE, warning =FALSE, out.width = "50%", fig.width=10, fig.height=10}
...
```{r figure3,fig.cap="Residual versus Leverage plot", echo=FALSE, warning =FALSE, fig.width=10, fig.height=10}
plot(model,which = 5)
```
