...
```{r diagnostic, fig.cap = "Regression diagnostics", echo=FALSE, warning=FALSE, fig.width=10, fig.height=10}
par(mfrow = c(2, 2))
plot(model)
```
...
```{r figure1,fig.cap="Scale-Location plot", echo=FALSE, warning =FALSE, fig.width=10, fig.height=10}
plot(model,which = 3)
```


## Appendix C {#appendixC}
```{r figure2,fig.cap="Normal QQ-plot", echo=FALSE, warning =FALSE, fig.width=10, fig.height=10}
plot(model,which = 2)
```


## Appendix D {#appendixD}
```{r figure3,fig.cap="Residual versus Leverage plot", echo=FALSE, warning =FALSE, fig.width=10, fig.height=4}
plot(model,which = 5)
```
