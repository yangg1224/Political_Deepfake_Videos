...
```{r postfavor, fig.cap="Distribution of feelings towards Sanders in six different situations",echo=FALSE, fig.width=6, fig.height=4}
...
```{r diagnostic, fig.cap = "Regression diagnostics", echo=FALSE, warning=FALSE, fig.width=6, fig.height=6}
par(mfrow = c(2, 2))
plot(model)
```
